defmodule Veggy.AcceptanceTest do
  ...
  test "command StartSharedPomodoro when one is ticking the other must rollback" do
    ...
    send_command %{"command" => "StartPomodoro", "timer_id" => navigator_timer_id, "duration" => 100}
    {:event, %{"pomodoro_id" => navigator_pomodoro_id}} =
    ...
    assert_receive {:event, %{"event" => "PomodoroCompleted", "pomodoro_id" => ^navigator_pomodoro_id}}, 200
  end
